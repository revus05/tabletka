    ...
    <footer className="bg-dark text-white mt-12">
      <div className="mx-auto max-w-[1200px] px-5 py-10">
        <div className="grid grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                href="#"
                className="flex items-center gap-3 border border-gray rounded-[4px] px-4 py-2 hover:border-white transition-colors"
              >
                ...
                <div>
                  <div className="text-[10px] text-gray">Доступно в</div>
              ...
              >
                ...
                <div>
                  <div className="text-[10px] text-gray">Загрузить в</div>
        ...
        <div className="mt-8 pt-6 border-t border-dark-alt flex items-center justify-between">
          ...
          <p className="text-[13px] text-gray">Лицензия МЗ РБ</p>
        </div>
      </div>
    </footer>
  );
