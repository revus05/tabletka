            ...
            <div className="flex flex-col gap-3">
              {results.map((med) => (
                <Link
                  ...
                  className="flex items-center gap-3 md:gap-5 bg-white border border-gray-border rounded-[4px] p-3 md:p-5 hover:border-brand hover:shadow-sm transition-all group"
                >
                  {/* Image */}
